...
import com.girlkun.models.boss.list_boss.FideBack.mvbtc41;
import com.girlkun.models.boss.list_boss.FideBack.mvbtc42;
import com.girlkun.models.boss.list_boss.FideBack.mvbtc43;
...
import com.girlkun.models.boss.list_boss.ginyu.sukientrungthu;
import com.girlkun.models.boss.list_boss.ginyu.CREAL;
...
import com.girlkun.models.boss.list_boss.Broly.SuperXayda;
//import com.girlkun.models.boss.list_boss.Broly.BrolyClone;
...
import com.girlkun.models.boss.list_boss.FideBack.JackyChung;
import com.girlkun.models.boss.list_boss.FideBack.Quylao;
...
//            this.createBoss(BossID.BROLY_CLONE);
            ...
            this.createBoss(BossID.SUPER);
            this.createBoss(BossID.sukientrungthu);
            this.createBoss(BossID.CREAL);
            ...
            this.createBoss(BossID.B1);
            this.createBoss(BossID.B2);
            this.createBoss(BossID.B3);
            this.createBoss(BossID.JACKY);
    ...
    public Boss createBoss(int bossID) {
        try {
            switch (bossID) {
                ...
                case BossID.POC:
                    return new Poc();
                case BossID.sukientrungthu:
                    return new sukientrungthu();
                case BossID.CREAL:
                    return new CREAL();    
                case BossID.AN_TROM:
                    return new AnTrom();
