...
//**************************************************************************
    //**************************************************************************
    public static final BossData B1 = new BossData(
            "Thần Trái Đất", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1299, 1300, 1301, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            100000, //dame
            ...
            new int[][]{
                    ...
                    {Skill.TAI_TAO_NANG_LUONG, 2, 25000},
            },//skill
    ...
    public static final BossData B2 = new BossData(
            "Thần Xayda", //name
            ConstPlayer.XAYDA, //gender
            new short[]{1305, 1306, 1307, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            200000, //dame
            new long[]{2000000000}, //hp
            new int[]{27}, //map join
            new int[][]{
                    ...
                    {Skill.GALICK, 7, 1000},
                    {Skill.KAMEJOKO, 7, 1000},
                  //  {Skill.BIEN_KHI, 7, 60000},              
                    {Skill.TAI_TAO_NANG_LUONG, 2, 25000},
                    {Skill.KHIEN_NANG_LUONG, 2, 25000},
    ...
    public static final BossData B3 = new BossData(
            "Thần namec", //name
            ConstPlayer.NAMEC, //gender
            new short[]{1302, 1303, 1304, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            250000, //dame
            new long[]{2000000000}, //hp
            new int[]{27}, //map join
            new int[][]{
                    {Skill.GALICK, 7, 1000},
                    {Skill.KAMEJOKO, 7, 1000},
                    {Skill.LIEN_HOAN, 7, 6000},
                    {Skill.THOI_MIEN, 7, 29000},
                    {Skill.DE_TRUNG, 7, 60000},
                    {Skill.TAI_TAO_NANG_LUONG, 2, 25000},
            },//skill//skill
            new String[]{}, //text chat 1
            new String[]{"|-1|Oải rồi hả?", "|-1|Ê cố lên nhóc",
            ...
            REST_15_M ,//type appear
             new int[]{BossID.B1, BossID.B2}
    );
    
    public static final BossData Mabu2h_1 = new BossData(
            "Mabư mập",
            ConstPlayer.XAYDA, //gender
            new short[]{297,298,299, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000,
            new long[]{550000000},
            new int[]{127}, //map join //map xuất hiện
            new int[][]{
                 {Skill.KAMEJOKO, 3, 7000},
                {Skill.GALICK, 2, 6000},
                {Skill.ANTOMIC, 3, 5000},
                 {Skill.TAI_TAO_NANG_LUONG, 3, 300000}},
            new String[]{
    ...
    public static final BossData Mabu2h_2 = new BossData(
            "Super Bư",
            ConstPlayer.XAYDA, //gender
            new short[]{421, 422, 423, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000,
            new long[]{650000000},
            new int[]{127}, //map join //map xuất hiện
            new int[][]{
                 {Skill.KAMEJOKO, 4, 7000},
                {Skill.GALICK, 2, 6000},
                {Skill.ANTOMIC, 4, 5000},
                 {Skill.TAI_TAO_NANG_LUONG, 4, 300000}},
            new String[]{
                    "|-1|Tuy không biết các ngươi là ai, nhưng ta rất ấn tượng đấy!",
            },
            new String[]{"|-1|Các ngươi tới số rồi mới gặp phải ta",
    ...
    public static final BossData Mabu2h_3 = new BossData(
            "Bư tenk",
            ConstPlayer.XAYDA, //gender
            new short[]{424, 425, 426, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000,
            new long[]{750000000},
            new int[]{127}, //map join //map xuất hiện
            new int[][]{
                 {Skill.KAMEJOKO, 5, 7000},
                {Skill.GALICK, 2, 6000},
                {Skill.ANTOMIC, 5, 5000},
                 {Skill.TAI_TAO_NANG_LUONG, 5, 300000}},
            new String[]{
                    "|-1|Tuy không biết các ngươi là ai, nhưng ta rất ấn tượng đấy!",
            },
            new String[]{"|-1|Các ngươi tới số rồi mới gặp phải ta",
    ...
    public static final BossData Mabu2h_4 = new BossData(
            "Bư han",
            ConstPlayer.XAYDA, //gender
            new short[]{427, 428, 429, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000,
            new long[]{1000000000},
            new int[]{127}, //map join //map xuất hiện
            new int[][]{
                 {Skill.KAMEJOKO, 6, 7000},
                {Skill.GALICK, 2, 6000},
                {Skill.ANTOMIC, 6, 5000},
                 {Skill.TAI_TAO_NANG_LUONG, 6, 300000}},
            new String[]{
                    "|-1|Tuy không biết các ngươi là ai, nhưng ta rất ấn tượng đấy!",
            },
            new String[]{"|-1|Các ngươi tới số rồi mới gặp phải ta",
    ...
    public static final BossData Mabu2h_5 = new BossData(
            "Kid Bư",
            ConstPlayer.XAYDA, //gender
            new short[]{439, 440, 441, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            200000,
            new long[]{1500000000},
            new int[]{127}, //map join //map xuất hiện
            new int[][]{
                 {Skill.KAMEJOKO, 7, 70000},
                {Skill.GALICK, 7, 60000},
                {Skill.ANTOMIC, 7, 50000},
    ...
    public static final BossData THODAIKA = new BossData(
            ...
            new int[][]{
              ...
              {Skill.ANTOMIC, 1, 130},  {Skill.ANTOMIC, 2, 140},  {Skill.ANTOMIC, 3, 150},{Skill.ANTOMIC, 4, 160},  {Skill.ANTOMIC, 5, 170},{Skill.ANTOMIC, 6, 190},  {Skill.ANTOMIC, 7, 200},
               ...
               {Skill.TAI_TAO_NANG_LUONG, 7, 35000},
            {Skill.KHIEN_NANG_LUONG, 7, 90000},},
            new String[]{}, //text chat 1
            new String[]{"|-1|HAHAHAHA", "|-1|Chỉ là bọn con nít"
            }, //text chat 2
    ...
    public static final BossData BULLMA = new BossData(
            "BunMa", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static final BossData MECKIE = new BossData(
            "Mackie", //name
            ConstPlayer.XAYDA, //gender
            new short[]{2006, 2007, 2008, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            180000, //dame
            new long[]{1500000000L}, //hp
            new int[]{182,183}, //map join
            new int[][]{
                    {Skill.LIEN_HOAN, 1, 300},{Skill.LIEN_HOAN, 2, 400},{Skill.LIEN_HOAN, 3, 500},{Skill.LIEN_HOAN, 4, 600},{Skill.LIEN_HOAN, 5, 700},{Skill.LIEN_HOAN, 6, 800},{Skill.LIEN_HOAN, 7, 900},
                {Skill.KAMEJOKO, 7, 600}, {Skill.KAMEJOKO, 6, 700}, {Skill.KAMEJOKO, 5, 800}, {Skill.KAMEJOKO, 4, 900}, {Skill.KAMEJOKO, 3, 1000}, {Skill.KAMEJOKO, 2, 1100},{Skill.KAMEJOKO, 1, 1002},
              {Skill.ANTOMIC, 1, 130},  {Skill.ANTOMIC, 2, 140},  {Skill.ANTOMIC, 3, 150},{Skill.ANTOMIC, 4, 160},  {Skill.ANTOMIC, 5, 170},{Skill.ANTOMIC, 6, 190},  {Skill.ANTOMIC, 7, 200},
...
public static final BossData OLIVER = new BossData(
            "OiLver", //name
            ConstPlayer.XAYDA, //gender
...
public static final BossData SUPER = new BossData(
            "Super Xayda", //name
            ConstPlayer.XAYDA, //gender
            new short[]{1326,1327,1328, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            1000000, //dame
            new long[]{2000000000}, //hp
            new int[]{29,30}, //map join
            new int[][]{
                    {Skill.THOI_MIEN, 3, 10000},
                    {Skill.KAMEJOKO, 7, 10000},
                    {Skill.GALICK, 7, 300},
             {Skill.TAI_TAO_NANG_LUONG, 1, 15000},},
            new String[]{"|-1|Tao là Super Xayda",
                    "|-2|Em chào đại ca!",
                    "|-1|Ai thèm làm đại ca của mày?"
            }, //text chat 1
            new String[]{"|-1|Chết hết đi cho tao",
    ...
    public static final BossData MAP_DAU_DINH = new BossData(
            ...
            new int[][]{
                    {Skill.GALICK, 7, 1000},
                    {Skill.ANTOMIC, 7, 10000},
             {Skill.THOI_MIEN, 3, 10000},},//skill //skill
...
public static final BossData JACKY = new BossData(
            " Jacky Chun",
            ConstPlayer.TRAI_DAT, //gender
...
public static final BossData QUYLAO = new BossData(
            "Quy Lão Kame",
            ConstPlayer.TRAI_DAT, //gender
...
//            TypeAppear.ANOTHER_LEVEL
    ...
    public static final BossData CUMBER = new BossData(
            ...
            ConstPlayer.XAYDA, //gender
            new short[]{1359,1360,1361, -1, 0, -1}, //outfit {head, body, leg, bag, aura, eff}
            200000, //dame
            new long[]{1500000000}, //hp
            new int[]{155}, //map join
            new int[][]{
...
//                    {Skill.DICH_CHUYEN_TUC_THOI, 7, 1000},
    ...
    public static final BossData TAU_PAY_PAY_BASE = new BossData(
            ...
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1317, 1318, 1319, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000000, //dame
            new long[]{2000000000}, //hp
...
//            new int[]{14}, //map join
    ...
    public static final BossData BROLY_CLONE = new BossData(
            ...
            100000,
            new long[]{100000000},
            new int[]{5, 6, 10, 13, 19, 20, 29, 30, 33, 34, 37, 38},
            new int[][]{
 ...
 public static final BossData SUPER_ANDROID_17 = new BossData(
            ...
            new int[][]{
                {Skill.KHIEN_NANG_LUONG, 7, 50000},
                    ...
                    {Skill.DICH_CHUYEN_TUC_THOI, 7, 10000},
                    {Skill.DE_TRUNG, 7, 10000},
                    {Skill.KAMEJOKO, 7, 100}},//skill//skill
            new String[]{}, //text chat 1
            new String[]{}, //text chat 2
            new String[]{}, //text chat 3
            REST_15_M
