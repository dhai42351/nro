...
public class BossID {
    ...
    public static final int FROST = -100;
    ...
    public static final int THODAIKA = -249;
    public static final int BULLMA = -250;
    public static final int sukientrungthu = -251;
    public static final int MECKIE = -252;
    public static final int OIL = -253;
    public static final int ELEC = -254;
    public static final int OLIVER = -255;
    public static final int CREAL = -255;
     public static final int B1= -257;
    public static final int B2 = -258;
    public static final int B3 = -259;
    ...
    public static final int SON_TINH = -666;
    public static final int SUPER = -667;
    ...
    public static final int BUI_BUI_2 = -238;
     ...
     //Mabu 2 giờ
    public static final int Mabu2h = -52;
    ...
    public static final int JACKY = -247;
    public static final int QUYLAO = -248;
