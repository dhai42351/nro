package com.girlkun.models.boss.list_boss.Mabu2h;
   ...
   @Override
    public void reward(Player plKill) {
        ...
        if (Util.isTrue(25, 100)) {
            if (Util.isTrue(4, 10)) {
                Service.getInstance().dropItemMap(this.zone, Util.ratiItem(zone, 555, 1, this.location.x, this.location.y, plKill.id));
                return;
            }
