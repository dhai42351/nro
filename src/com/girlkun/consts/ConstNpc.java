...
public static final String HUONG_DAN_DOI_SKH_VIP = "Nguyên liệu cần để làm SKH VIP là :\n"
 ...
 public static final String HUONG_DAN_THAN_MEO = " Gặp Npc Thần Mèo , Chọn Hộ Tống Rồi Dắt Mị đếnVị Trí được chỉ định :\n "
            + "Phần quà Ngẫu nhiên 100-500 Ngọc Hồng , Ngẫu nhiên 1-5 Thỏi Vàng ..";
 
     public static final String HUONG_DAN_MOC_NAP = "|1|Mốc 100K: X50 HỘP SET KÍCH HOẠT,  5 BỘ NRO\b"
             + "|1|Mốc 300k: 15 BỘ NRO, x999(cn,bh,gx,bk)C2, X3 ĐỆ GOKU, X3 THẺ THAY CHIÊU 2-3 ĐỆ, CẢI TRANG CUMBER 35%\b"
             + "|1|Mốc 500K: X50 THẺ MẢNH ĐỘI TRƯỞNG VÀNG, X3 ĐỆ CUMBER, CAPSULE PET, CẢI TRANG VAGETA SSJ4 40%, X50 3S, x2000 VIÊN ĐÁ NANG CẤP CÁC LOẠI\b"
             + "|1|Mốc 1TR: X100 MẢNH ĐỘI TRƯỞNG VÀNG, X100 THẺ RỒNG THẦN NAMEC, CAPSULE CẢI TRANG, CAPSULE PET, CẢI TRANG SUPER GOGETA SS4 45% x99 3S";
 public static final String HUONG_DAN_MAP_2h = "Ma nhưng bơ sắp được hồi sinh "
    ...
    public static final byte ONGGIANOEL = 98;
    public static final byte THOREN= 100;
    ...
    public static final int MENU_1 = 10003;
    public static final int MENU_2 = 10004;
    ...
    public static final int MENU_OPENED_DOANH_TRAI = 503;
    public static final int MENU_ACCPET_GO_TO_KG = 538;
    //khigas
...
//    public static final int CONFIRM_ACTIVE = 518;
    ...
    public static final int MENU_OPTION_USE_ITEM1105 = 1105;
     public static final int MENU_OPTION_USE_ITEM1269 = 1269;
