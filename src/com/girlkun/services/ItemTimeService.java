...
public class ItemTimeService {
    ...
    public void sendAllItemTime(Player player) {
        ...
        if (player.itemTime.isUseThuocmo) {
            sendItemTime(player, 9068, (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimeThuocmo)) / 1000));
        }
        if (player.itemTime.isUseThuocmo2) {
            sendItemTime(player, 9109, (int) ((TIME_MAY_DO - (System.currentTimeMillis() - player.itemTime.lastTimeThuocmo2)) / 1000));
        }
        ...
        if (player.itemTime.isUseAnDanh2) {
         ...
         if (player.itemTime.isUseTrungthu) {
            sendItemTime(player, 4125, (int) ((TIME_ITEM60P- (System.currentTimeMillis() - player.itemTime.lastTimeTrungthu)) / 1000));
        }
        if (player.itemTime.isUseHoptrungthu) {
            sendItemTime(player, 4126, (int) ((TIME_ITEM90P - (System.currentTimeMillis() - player.itemTime.lastTimeHoptrungthu)) / 1000));
        }
