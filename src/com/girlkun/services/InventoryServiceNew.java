...
import com.barcoll.MaQuaTang.MaQuaTang;
...
public boolean HaveItemIdInBag(Player player, int tempId) {
    ...
    if (where == 0) {
        ...
        if (itemThrow.template.id != 457// thỏi vàng và Pha Lê Z
//                && itemThrow.template.id != 454 && itemThrow.template.id != 921 //Bông tai Porata cấp 1 và 2
                && itemThrow.template.id != 194 //Capsule VIP
//                && itemThrow.template.id != 529 && itemThrow.template.id != 530 && itemThrow.template.id != 531 && itemThrow.template.id != 534 && itemThrow.template.id != 535 && itemThrow.template.id != 536
                ) {
        ...
        if (itemAdd.template.isUpToUp) {
            for (Item it : items) {
                ...
                if (itemAdd.template.id == 457
                        ...
                        || itemAdd.template.type == 1232
                        || itemAdd.template.type == 1233
                        || itemAdd.template.type == 1234
                        
                        //Mảnh bông tai
                        || itemAdd.template.type == 933
                        || itemAdd.template.type == 934
                        || itemAdd.template.type == 1164
                        || itemAdd.template.type == 1165
                        || itemAdd.template.type == 2043
                        //Thiên Sứ
                        ...
                        || itemAdd.template.id == 1125
                        || itemAdd.template.id == 1201) {
