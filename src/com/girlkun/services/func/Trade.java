...
//System.out.println("quantity: " + quantity);
    ...
    private boolean isItemCannotTran(Item item) {
        ...
        if(item.template.id == 454 ||item.template.id == 2132 ||item.template.id == 2064 ||item.template.id == 2129 ||item.template.id == 2130 ||item.template.id == 2131 ){
            return true;
        }
...
//         else {
//             Service.getInstance().sendThongBaoFromAdmin(pl,
//                    "|7| Chức Năng Yêu Cầu Mở Thành Viên Để Sử Dụng\b|2| Liên Hệ Admin Để Mở Thành Viên\b|6|Chúc bạn chơi game vui vẻ");
//             removeItemTrade(pl, index);
//         }
//     }
//     }
