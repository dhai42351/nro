...
public class SummonDragon {
    ...
    public static final short NGOC_RONGTRB1 = 1166;
    public static final short NGOC_RONGTRB2 = 1167;
    public static final short NGOC_RONGTRB3 = 1168;
    ...
    public void openMenuSummonShenronTRB(Player pl, byte ShenronBalltrb) {
        this.pl_dragonStar.put(pl, ShenronBalltrb);
    ...
    private void sendWhishesNamec(Player pl) {
        NpcService.gI().createMenuRongThieng(pl, ConstNpc.NAMEC_1, "Ta sẽ ban cho cả bang ngươi 1 điều ước, ngươi có 5 phút, hãy suy nghĩ thật kỹ trước khi quyết định", "x1 ngọc rồng 3 sao");
    }
                ...
                switch (this.select) {
                    ...
                    case 2: //chí mạng +2%
                        if (this.playerSummonShenron.nPoint.critg < 10) {
                            this.playerSummonShenron.nPoint.critg += 1;
                        } else {
            ...
            case ConstNpc.SHENRON_1_2:
                switch (this.select) {
                    ...
                    case 1: //+1,5 ngọc
                        ...
                        break;
                    case 2: //+200 tr smtn 
                        if (this.playerSummonShenron.nPoint.power >= 2000) {
