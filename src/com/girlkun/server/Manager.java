...
//    public static byte RATE_EXP_SERVER = 1;// sau khi chinh
    ...
    public static final short[] aotd = { 231, 232, 233, 555};
    public static final short[] quantd = { 243, 244, 245, 556};
    public static final short[] gangtd = { 255, 256, 257, 562};
    public static final short[] giaytd = { 267, 268, 269, 563};
    public static final short[] aoxd = { 239, 240, 241, 559};
    public static final short[] quanxd = { 251, 252, 253, 560};
    public static final short[] gangxd = { 263, 264, 265, 566};
    public static final short[] giayxd = { 275, 276, 277, 567};
    public static final short[] aonm = { 235, 236, 237, 557};
    public static final short[] quannm = { 247, 248, 249, 558};
    public static final short[] gangnm = { 259, 260, 261, 564};
    public static final short[] giaynm = { 271, 272, 273, 565};
    public static final short[] radaSKHVip = { 279, 280, 281, 561};
    //ist mts
