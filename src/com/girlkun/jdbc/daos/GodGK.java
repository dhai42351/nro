     ...
     public static Player loadById(int id) {
        ...
        try {
            ...
            if (rs.first()) {
                ...
                int timeMeal = Integer.parseInt(String.valueOf(dataArray.get(7)));
                int iconMeal = Integer.parseInt(String.valueOf(dataArray.get(8)));
                int timeBanhChung = Integer.parseInt(String.valueOf(dataArray.get(9)));
                int timeBanhTet = Integer.parseInt(String.valueOf(dataArray.get(9)));
//                int timeTrungthu = Integer.parseInt(String.valueOf(dataArray.get(10)));
//                int timeHoptrungthu = Integer.parseInt(String.valueOf(dataArray.get(11)));
                //int timeBanhSau= Integer.parseInt(String.valueOf(dataArray.get(10)));
                
                //int timeBanhNhen = Integer.parseInt(String.valueOf(dataArray.get(11)));
                //int timeKeoMotMat = Integer.parseInt(String.valueOf(dataArray.get(12)));
               // int timeSupBi = Integer.parseInt(String.valueOf(dataArray.get(13)));
                //int timeThuocMo = Integer.parseInt(String.valueOf(dataArray.get(14)));
               // int timeThuocMo2 = Integer.parseInt(String.valueOf(dataArray.get(14)));
                ...
                player.itemTime.lastTimeUseMayDo2 = System.currentTimeMillis() - (ItemTime.TIME_MAY_DO2 - timeMayDo2);
                player.itemTime.lastTimeEatMeal = System.currentTimeMillis() - (ItemTime.TIME_EAT_MEAL - timeMeal);
                 player.itemTime.lastTimeBanhTet = System.currentTimeMillis() - (ItemTime.TIME_ITEM45P - timeBanhTet);
                player.itemTime.lastTimeBanhChung = System.currentTimeMillis() - (ItemTime.TIME_ITEM45P - timeBanhChung);
               // player.itemTime.lastTimeBanhSau = System.currentTimeMillis() - (ItemTime.TIME_MAY_DO - timeBanhSau);
                //player.itemTime.lastTimeBanhNhen = System.currentTimeMillis() - (ItemTime.TIME_MAY_DO - timeBanhNhen);
//                player.itemTime.lastTimeKeoMotMat = System.currentTimeMillis() - (ItemTime.TIME_MAY_DO - timeKeoMotMat);
//                player.itemTime.lastTimeSupBi = System.currentTimeMillis() - (ItemTime.TIME_MAY_DO - timeSupBi);
//                player.itemTime.lastTimeThuocmo = System.currentTimeMillis() - (ItemTime.TIME_ITEM - timeThuocMo);
//                player.itemTime.lastTimeThuocmo2 = System.currentTimeMillis() - (ItemTime.TIME_MAY_DO - timeThuocMo2);
               // player.itemTime.lastTimeTrungthu = System.currentTimeMillis() - (ItemTime.TIME_ITEM60P - timeTrungthu);
               // player.itemTime.lastTimeHoptrungthu = System.currentTimeMillis() - (ItemTime.TIME_ITEM90P - timeHoptrungthu);
...
//                player.itemTime.isUseThuocmo = timeThuocMo != 0;
//                player.itemTime.isUseThuocmo2 = timeThuocMo2 != 0;
//                 player.itemTime.isUseTrungthu = timeTrungthu != 0;
//                player.itemTime.isUseHoptrungthu = timeHoptrungthu != 0;
